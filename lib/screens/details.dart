...
import 'package:proj/models/assessment.dart';
import 'package:proj/models/form.dart';
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Scaffold(appBar: AppBar(leading: Container(),title: Text(widget._data.member.shortName),centerTitle: true,
    ),
